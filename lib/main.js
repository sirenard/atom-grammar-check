...
class GrammarCheckerManager {
    ...
    loadNewGrammarChecker(editor) {
        ...
        let newGrammarChecker = new GrammarChecker(editor, this, this.generateName(), this.usedCorrecter);
    ...
    clearContextMenuEntries() {
        console.log("Clear", this.contextMenuEntries.length)
